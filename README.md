...
- **[Fantasy Football Faceoff](https://github.com/nguyen-amy/fantasy-football)**: Pipeline collects NFL stats from the DataFeeds API and historical CSVs, stores in GCS, exposes a FastAPI service for retrieval and analysis, and (optionally) visualize via Streamlit. *(REST APIs, Docker, GCS, FastAPI, Streamlit)*
