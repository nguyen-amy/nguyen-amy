...
- **[SF 311 Analysis - End-to-end Data Pipeline & ML System](https://github.com/nguyen-amy/SF-311-Data-Analysis)**: Daily Airflow-orchestrated pipeline, ingesting millions of SF 311 records from the Socrata API into MongoDB, processes with PySpark on GCS Parquet, and trains a Spark ML model to predict case resolution times. *(PySpark, MongoDB, Airflow, GCP (GCS, Dataproc-style Spark jobs), Spark MLlib, MLflow, REST APIs, geospatial visualization, data pipeline design.)*
